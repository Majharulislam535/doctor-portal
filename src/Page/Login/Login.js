...
const Login = () => {
    ...
    const { logInEmail, loading, user, error } = useFirebase();
                    ...
                    <div className='flex justify-center items-center'>
                        {
                            loading ? <svg role="status" className="inline mr-2 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='w-11/12'>
                                    <h1 className='text-center py-8 font-bold text-3xl text-primary'>Login</h1>
                                    ...
                                    <Link to="/register">
                                        <h1 className='text-center py-4 text-primary text-lg'>New user?please register</h1>
                                    </Link>
